...
die "<fetal DNA concentration> <merge genotype> <maternal haplotypes> <paternal haplotypes> <cfDNA name in vcf:17P0900108-2_8lane> <maternal name in vcf:17B0900108D or GJ> <paternal name in vcf:GJZF> " unless @ARGV==7;
